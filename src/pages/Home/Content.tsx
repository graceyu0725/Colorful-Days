  ...
  return (
    <div className='flex flex-col justify-center items-center px-6 xs:px-10 sm:pl-20 w-full lg:w-1/2 h-[calc(100vh_-_64px)] mt-16'>
      <div className='flex flex-col gap-2 2xl:gap-3'>
        <div className='text-3xl sm:text-4xl xl:text-5xl text-gray-700 2xl:text-6xl'>Organize your days</div>
        <div className='text-3xl sm:text-4xl xl:text-5xl text-gray-700 2xl:text-6xl'>with a splash of color in</div>
        <div className='flip overflow-hidden h-12 xl:h-16 relative 2xl:h-20'>
